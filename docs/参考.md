...
| [google/protobuf/dynamic_message.h](https://developers.google.com/protocol-buffers/docs/reference/cpp/google.protobuf.dynamic_message) | 定义[消息](https://developers.google.com/protocol-buffers/docs/reference/cpp/google.protobuf.message#Message)的实现，该实现可以模拟编译时未知的类型的。                                                                                                                                                        |
